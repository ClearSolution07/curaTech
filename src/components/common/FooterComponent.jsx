  ...
  return (
    <div style={{ color: "#fff" }}>
      <Row>
        ...
        >
          ...
          >
            <Row style={{ marginTop: "16px", marginBottom: "20px" }}>
              <img
                src={logoImage} // This is the image you imported
                alt="Dustro Logo"
                style={{ width: "150px", height: "auto" }} // Adjust the size as necessary
              />
            </Row>
            ...
            <Row>
              ...
              >
                Fusce eu magna quis velit efficitur rhoncus. <br />
        ...
        {/* Right Section with Dark Blue Background */}
        <Col
          xs={24}
          md={18}
          style={{
            backgroundColor: "#00215b", // Dark blue background
            padding: "66px",
          }}
        >
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} md={8}>
              ...
              <Space direction="vertical" size="large">
                <div>
                  <Link href="#" style={{ color: "#fff", fontSize: "16px" }}>
                    Agile Construction <br /> Management Building
                  </Link>
                  <br />
                ...
                <div>
                  <Link href="#" style={{ color: "#fff", fontSize: "16px" }}>
                    Top Saas Construction <br /> Products Information
                  </Link>
                  <br />
                  <Text style={{ color: "#ddd", fontSize: "12px" }}>
